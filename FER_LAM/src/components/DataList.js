...
function DataList() {
  ...
  const filteredData = dataList
    ...
    // PAGINATION LOGIC
    let indexLast = currentPage * dataDefault
    let indexFirst = (currentPage - 1) * dataDefault
    const newData = filteredData.slice(indexFirst, indexLast);
    // (1 -1 ) * 5 => 5 (- 1
    // (2 -1 ) * 5 => 10 (- 1 
    // (3 - 1) * 5
  ...
  return (
    <>
      <div>
        ...
        <PaginationCode filteredData={filteredData}/>
      </div>
